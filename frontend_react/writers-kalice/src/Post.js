    ...
    render() {
        return (
            <div className="p-12 md:w-1/2 flex flex-col items-start border-dashed">
                <h2 className="sm:text-3xl text-2xl title-font font-medium text-white mt-4 mb-4">{this.props.title}</h2>
                <p className="leading-relaxed mb-4">{this.props.content}</p>
                <div
                    className="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-800 mt-auto w-full">
                    <a className="text-purple-500 inline-flex items-center mb-8" onClick={this.handleReadMore}>Read
