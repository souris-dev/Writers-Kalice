...
export default class SavedPostsPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            posts: []
    ...
    componentDidMount() {
        fetch(serverUrl + "/posts/getsavedposts?userId=" + window.localStorage.getItem("wKuid"), { method: 'GET' })
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="hidden md:block">
                                    <div className="ml-10 flex items-baseline space-x-4">
                                        ...
                                        <a href="#"
                                            className="px-3 py-2 rounded-md text-sm font-medium text-white bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700">Saved Posts</a>
